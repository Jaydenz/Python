...
class Scan:  
    def __init__(self,root):  
        ...
        iplabel = Label(frame, text="输入IP:",font='微软雅黑')  
        ...
        resultlabel = Label(frame, text="扫描结果如下:", font='微软雅黑')  
        resultlabel.grid(row=1, column=0, padx=5, pady=5, sticky=W,columnspan=2)  
        self.resulttext=ScrolledText(frame,width=30, height=12,font=('微软雅黑', 13),fg='black',bg='white')  
